...
public class CollaborateScriptGoldPoolTest extends TestCase {
    private static Random rand = new Random();

    private static String REGION = "ap-northeast-1";
    private static String accessToken = null;
    private static String CLIENT_ID = "gs2_gold_test_seeds.CollaborateScriptGoldPoolTest-java";
    private static String CLIENT_SECRET = "jBCjR7Tpbyj8qEXkzG53QHDuoZxjKnNYoJonEz//lz0=";
